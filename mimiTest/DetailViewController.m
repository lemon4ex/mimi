...
#import "LMContryCodeViewController.h"
#import "NSDictionary+DeepMutableCopy.h"

#import <SMS_SDK/SMS_SDK.h>

/*?--CONFUSED_ONCE--?*/
@interface LMContryCodeViewController ()
{
    NSMutableData*_data;
    int _state;
    NSString* _duid;
...
@implementation LMContryCodeViewController
@synthesize names;
@synthesize keys;
@synthesize table;
@synthesize search;
...
- (void)createView
{
    ...
    table=[[UITableView alloc] initWithFrame:CGRectMake(0, 44, self.view.frame.size.width, self.view.frame.size.height- NAVIGATION_BAR_HEIGHT - STATUS_BAR_HEIGHT - 44) style:UITableViewStylePlain];
